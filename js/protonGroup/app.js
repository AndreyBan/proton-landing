...
document.addEventListener('DOMContentLoaded', function () {
  var choiceSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.choice-slider', {
    slidesPerView: "auto",
    centeredSlides: true,
    freeMode: true,
    breakpoints: {
  ...
  var changedTab = document.querySelector('.choice-product__changed');
  choiceSlider.on('slideChange', function () {
    var tab = document.querySelector('.choice-product__list li[data-slide="' + choiceSlider.activeIndex + '"]');
  ...
  var runChangeTab = changeTab('.choice-product__changed', '.choice-product__list', '767.98px');
  var runMenu = changeTab('.header__active-nav', '.header__nav', '1279.98px');
  ...
  arrowSlider.left.addEventListener('click', function () {
    return portfolioSlider.slidePrev();
  });
  arrowSlider.right.addEventListener('click', function () {
    return portfolioSlider.slideNext();
  });
  _fancyapps_ui__WEBPACK_IMPORTED_MODULE_1__.Fancybox.bind("[data-fancybox]", {
    mainClass: 'expert-popup',
    dragToClose: false
  });
  _fancyapps_ui__WEBPACK_IMPORTED_MODULE_1__.Fancybox.bind("[data-fancybox-form]", {
    mainClass: 'popup-window',
    dragToClose: false,
    on: {
      destroy: function destroy() {
        document.querySelector('.snack-wrap').classList.remove('show');
      }
    }
  });
});
...
function resetHeightSlides() {
  var slides = document.querySelectorAll('.choice-product-item');
...
function setMaxHeightSlides() {
  var maxHeight = detectMaxHeightElement('.choice-product-item'),
...
function activeTabSlider(tabClassName) {
  var slider = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
  ...
  $tabs.forEach(function (el) {
    el.addEventListener('click', function () {
      ...
      if (slider) {
        var activeTabIndex = this.getAttribute('data-slide');
...
function getNextPrevElements(el, next) {
  var arr = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  var checkEl = next ? el.nextElementSibling : el.previousElementSibling;
...
function getSiblings($this) {
  return [].concat(_toConsumableArray(getNextPrevElements($this, false)), _toConsumableArray(getNextPrevElements($this, true)));
}
/**
...
function detectMaxHeightElement(el) {
  ...
  elements.forEach(function (el) {
    return maxHeight = el.clientHeight > maxHeight ? el.clientHeight : maxHeight;
  });
  return maxHeight;
}
/**
...
function scrollToTarget() {
  document.querySelectorAll('[data-scroll]').forEach(function (link) {
    link.addEventListener('click', function (e) {
      ...
      var scrollTarget = document.querySelector('[data-scroll-target=' + href + ']');
...
function headerShow() {
  var posTop = document.querySelector('.partners').offsetTop;
...
function detectMenuActiveScroll() {
  var sections = document.querySelectorAll('[data-scroll-target]');
  var elementPositions = {};
  sections.forEach(function (el) {
    elementPositions[el.getAttribute('data-scroll-target')] = el.offsetTop;
  });
  var arKeys = Object.keys(elementPositions);
  var delay = {
    pos: 0
  };
  addEventListener('scroll', function () {
    var scroll = scrollY + 300;
...
function computedActive(arKeys, elementPositions, scroll) {
  for (var i = 0; i <= arKeys.length; i++) {
    if (scroll < elementPositions[arKeys[0]]) {
      document.querySelector('[data-scroll=' + arKeys[0] + ']').classList.remove('active');
      return false;
    }
...
function setActiveMenu(target) {
  var el = document.querySelector('[data-scroll=' + target + ']');
...
function expertTabs() {
  var tabs = document.querySelectorAll('.experts-card-cases-list [data-tab]');
  tabs.forEach(function (el) {
    el.addEventListener('click', function () {
      var siblings = getSiblings(this);
      this.closest('.experts-card-cases').setAttribute('data-active-tab', this.getAttribute('data-tab'));
      this.classList.add('active');
      siblings.forEach(function (el) {
        return el.classList.remove('active');
      });
...
function initPhoneMask(el) {
  new imask__WEBPACK_IMPORTED_MODULE_2__["default"](el, {
    mask: '+7 (000) 000-00-00',
    prepare: function prepare(val, masked) {
      return !masked.value && val === '8' ? "" : val;
    }
  });
}
/**
...
function sendForm() {
  document.addEventListener('submit', function (e) {
    if (e.target.getAttribute('data-form') !== null) {
      e.preventDefault();
      var fields = e.target.querySelectorAll('[data-field][data-req]'); // Получаем массив незаполненных обязательных полей

      var emptyFields = Array.prototype.slice.call(fields).filter(function (field) {
        return !field.value;
      }); // Выводим ошибку
...
function printFormErrors(emptyFields) {
  if (emptyFields.length) {
    emptyFields.forEach(function (empty) {
      var parent = empty.closest('.form-group');
...
function onAjaxSuccess(response) {
  var textMessage = "К сожалению произошла ошибка отправки данных. <br> Пожалуйста повторите позже.";
  ...
  document.body.insertAdjacentHTML("beforeend", "<div id='success-message' style='display: none; text-align: center'>" + textMessage + "</div>");
  var fancybox = new _fancyapps_ui__WEBPACK_IMPORTED_MODULE_1__.Fancybox([{
    src: "#success-message",
    type: "inline"
  }]);
  ...
  new Promise(function (resolve) {
    ...
    return document.getElementById('success-message').remove();
  });
}
/**
...
function showSnack() {
  ...
  var error = document.querySelector('.snack-wrap');
  error.classList.add('show');
  error.classList.add('show--' + type);
  setTimeout(function () {
    error.classList.remove('show');
    setTimeout(function () {
      error.classList.remove('show--' + type);
    }, 500);
  }, 3000);
}
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/@fancyapps/ui/dist/fancybox.css":
/*!****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[7].oneOf[1].use[2]!./node_modules/@fancyapps/ui/dist/fancybox.css ***!
  \****************************************************************************************************************************************************************************************************************/
...
/******/ 		var installedChunks = {
/******/ 			"/js/protonGroup/app": 0,
/******/ 			"css/protonGroup/all": 0,
/******/ 			"css/all": 0
/******/ 		};
/******/ 		
...
/******/ 	__webpack_require__.O(undefined, ["css/protonGroup/all","css/all"], () => (__webpack_require__("./src/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/protonGroup/all","css/all"], () => (__webpack_require__("./src/scss/all.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/protonGroup/all","css/all"], () => (__webpack_require__("./css/all.css")))
